...
module Dry
  module Env
    class Resolver
      ...
      #
      # @api public
      setting :environment, ENV, reader: true
      ...
      #
      # @api public
      setting :prefix, EMPTY_STRING, reader: true
      ...
      #
      # @api public
      setting :namespace, EMPTY_STRING, reader: true
      ...
      #
      # @api public
      setting :target, DEFAULT_TARGET, reader: true

      # Returns the environment string set on the class config.
      #
      # @return [String]
      #
      # @api protected
      ...
      # Returns the prefix string set on the class config.
      #
      # @return [String]
      #
      # @api protected
      ...
      # Returns the namespace string set on the class config.
      #
      # @return [String]
      #
      # @api protected
      ...
      # Returns the target string set on the class config.
      #
      # @return [String]
      #
      # @api protected
      ...
      #
      # @api public
      def optional(key, default_value = DEFAULT_VALUE)
        required(key)
